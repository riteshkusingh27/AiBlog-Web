...
const Navbar = () => {
  ...
  return (
    <div  className="flex justify-between items-center py-5 mx-8 sm:mx-20 cursor-pointer" >
       ...
       <button  onClick={()=>navigate('/admin')} className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-3xl hover:bg-[#3f3bbd] transition-all duration-300">  login
